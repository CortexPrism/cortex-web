...
5. **Channel Setup** — Multi-select from 10 integrations: Web UI, Discord, Slack, Telegram, Microsoft Teams, Mattermost, Rocket.Chat, WhatsApp, Google Chat, and Lark. Per-channel credential prompts are shown for each selected channel.

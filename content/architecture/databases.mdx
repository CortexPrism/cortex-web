...
Core migrations (23+ total across all databases):
...
| 010-023 | Various | Hub nodes, agents, services, skills, channels, workflows, onboarding, evaluations, triggers, MQM, voice, computer use |

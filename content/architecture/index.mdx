...
| **Pipeline System** | 12-stage hook-based processing pipeline for the agent turn lifecycle (pre/post-assess, pre/post-reason, pre/post-tool, pre/post-llm, pre/post-reflect, pre/post-output) |

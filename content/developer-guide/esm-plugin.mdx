...
1. **Local directory**: `cortex plugins install ./path/to/plugin`
2. **Marketplace**: `cortex plugins install marketplace:cortexprism.io/plugins/my-plugin`
3. **URL**: `cortex plugins install https://example.com/plugin.js`

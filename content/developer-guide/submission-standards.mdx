...
- [ ] Supply-chain verification passes (`cortex plugins verify my-plugin`): SHA-256 hash, signatures, malware scan
- [ ] AgentLint passes with no errors (`cortex agent lint check <agent-id>`)
- [ ] All capabilities work in a chat session (`cortex chat --agent my-agent`)

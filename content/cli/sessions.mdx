...
Each session gets a dedicated SQLite database (`sessions/<id>.db`) stored in the data directory. This keeps session data isolated and allows efficient loading of history when resuming.
